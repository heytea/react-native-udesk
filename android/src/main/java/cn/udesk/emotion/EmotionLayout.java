...
//            mSettingTab.setVisibility(mEmotionSettingVisiable ? View.VISIBLE : View.GONE);
    ...
    private void init() {
        try {
            ...
            inflater.inflate(R.layout.udesk_emotion_layout, this);
    ...
    private void initTabs() {
        ...
        try {
            ...
            //最后添加一个表情设置Tab
            mSettingTab = new EmotionTab(mContext, R.drawable.udesk_001);
    ...
    public void selectTab(int tabPosi) {
        try {
            ...
            for (int i = 0; i < mTabCount; i++) {
                ...
                if (tab != null){
                    tab.setBackgroundResource(R.drawable.udesk_shape_tab_normal);
                }
            }
            mTabViewArray.get(tabPosi).setBackgroundResource(R.drawable.udesk_shape_tab_press);
            //显示表情内容
            ...
            for (int i = 0; i < forMax; i++) {
                if (pageCount <= hasCount) {
                    ...
                    if (i < hasCount) {
                        ...
                        ivCur.setBackgroundResource(R.drawable.udesk_selector_view_pager_indicator);
